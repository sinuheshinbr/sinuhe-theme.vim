...
hi String guifg=#7c9d78 ctermfg=108 guibg=NONE ctermbg=NONE gui=italic cterm=italic
hi Character guifg=#7c9d78 ctermfg=108 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi DiffAdd guifg=#282a36 ctermfg=236 guibg=#7c9d78 ctermbg=108 gui=NONE cterm=NONE
...
hi TSStringRegex guifg=#7c9d78 ctermfg=108 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi TSCharacter guifg=#7c9d78 ctermfg=108 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi TSFloat guifg=#7c9d78 ctermfg=108 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi TSProperty guifg=#7c9d78 ctermfg=108 guibg=NONE ctermbg=NONE gui=italic cterm=italic
...
hi TSKeyword guifg=#7c9d78 ctermfg=108 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi TSType guifg=#7c9d78 ctermfg=108 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSStructure guifg=#ff00ff ctermfg=201 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSInclude guifg=#7c9d78 ctermfg=108 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi TSTag guifg=#c69650 ctermfg=173 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi markdownCode guifg=#7c9d78 ctermfg=108 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi markdownCodeBlock guifg=#7c9d78 ctermfg=108 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi markdownCodeDelimiter guifg=#7c9d78 ctermfg=108 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi CocExplorerBufferNameVisible guifg=#7c9d78 ctermfg=108 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi StartifySelect guifg=#7c9d78 ctermfg=108 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi StartifyHeader guifg=#7c9d78 ctermfg=108 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi StartifySection guifg=#b294bb ctermfg=139 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi StartifyFooter guifg=#7c9d78 ctermfg=108 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi WhichKey guifg=#b294bb ctermfg=139 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi WhichKeySeperator guifg=#7c9d78 ctermfg=108 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi diffAdded guifg=#7c9d78 ctermfg=108 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi diffNewFile guifg=#7c9d78 ctermfg=108 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
